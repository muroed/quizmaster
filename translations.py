...
class Translation:
    ...
    translations = {
        'en': {
            ...
            'waiting_for_game': 'Waiting for the game to start...',
            'first_question_appear': 'The first question will appear here once the moderator starts the game.',
            'question': 'Question',
            'team': 'Team',
        ...
        'ru': {
            ...
            'first_question_appear': 'Первый вопрос появится здесь, когда модератор начнет игру.',
            'question': 'Вопрос',
            'team': 'Команда',
